...
LangString LangDialog_Title ${LANG_CZECH} "Instalace OESENC_PI 1.0.0"
...
LangString Uninstall_Link ${LANG_CZECH} "Odinstalovat OESENC_PI 1.0.0"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_CZECH} "OESENC_PI 1.0.0 je již nainstalováno."
...
LangString Label_TypeInst_Reinstall_Text ${LANG_CZECH} "OESENC_PI 1.0.0 je již na Vašem systému nainstalováno. Nyní můžete přeinstalovat verzi s původní nastavením. Pokud chcete nainstalovat program s jiným nastavením, zrušte instalaci a odinstalujte napřed původní verzi. Klikněte na Další pro pokračování."
...
LangString ^NameDA ${LANG_CZECH} "OESENC_PI Verze 1.0.0"
...
LangString Label_TypeInst_Parallel_Text ${LANG_CZECH} "Setup has detected several installed versions of OESENC_PI on your system.  On the next screen, you will be asked to choose the desired install location for OESENC_PI Version 1.0.0."

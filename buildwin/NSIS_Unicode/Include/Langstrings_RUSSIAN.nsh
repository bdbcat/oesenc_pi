...
LangString LangDialog_Title ${LANG_RUSSIAN} "Установка OESENC_PI 1.0.0"
...
LangString Uninstall_Link ${LANG_RUSSIAN} "Удаление OESENC_PI 1.0.0"
...
LangString Page_TypeInst_Subtitle_Exists ${LANG_RUSSIAN} "Программа OESENC_PI 1.0.0 уже установлена."
...
LangString Label_TypeInst_Reinstall_Text ${LANG_RUSSIAN} "Программа OESENC_PI 1.0.0 уже установлена на вашем компьютере. Вы можете переустановить эту версию с сохранением имеющейся конфигурации. Чтобы установить программу с новой конфигурацией, отмените текущую установку и затем удалите имеющуюся версию. Нажмите «Далее» для продолжения."
...
LangString ^NameDA ${LANG_RUSSIAN} "OESENC_PI, версия 1.0.0"
...
LangString Label_TypeInst_Parallel_Text ${LANG_RUSSIAN} "Setup has detected several installed versions of OESENC_PI on your system.  On the next screen, you will be asked to choose the desired install location for OESENC_PI Version 1.0.0."
